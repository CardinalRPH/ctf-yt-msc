const MediaContainer = () => {
  return (
    <div className="fixed w-full bg-zinc-800 ring-zinc-400 ring-1 h-16 z-50 bottom-0">
      {/* seeker */}
      ...
      <div className="flex px-7 justify-between">
        <div className="flex py-2 gap-4">
          <button className=" cursor-pointer p-2 ease-in duration-150  active:bg-zinc-400 rounded-full">
            <svg
        ...
        <div className="flex items-center">
          ...
          <div className="px-1">
            <h3 className="font-bold text-white">Lorem</h3>
            <h4 className="text-zinc-400">Ipsum{" • "}DOlor</h4>
          </div>
          <div className="flex gap-6 px-1 md:px-3">
            <button className="ease-in duration-150  active:bg-zinc-400 p-1 rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                className="h-7 w-7 text-white -scale-x-100"
                fill="currentColor"
              >
            ...
            <button className="ease-in duration-150  active:bg-zinc-500 py-1 px-2 rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex gap-6 px-1 py-2 md:px-3">
          <button className="ease-in duration-150 px-1 py-2 active:bg-zinc-500  rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <button className="ease-in duration-150  active:bg-zinc-500 px-1 py-2 rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5 text-zinc-400"
              fill="currentColor"
